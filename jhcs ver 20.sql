...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2018 at 02:38 AM
...
INSERT INTO `client_machreturn` (`client_machReturnID`, `mach_returnDate`, `mach_returnQty`, `client_id`, `mach_id`, `mach_serial`, `mach_remarks`, `mach_returnAction`) VALUES
(13, '2018-03-14', 1, '', 1, 's555', 'for repair', '');
...
(10, '2018-03-26', NULL, NULL, 'OUT'),
(11, '2018-03-26', NULL, NULL, 'OUT'),
(12, '2018-03-26', NULL, NULL, 'OUT');
...
(1, 'Saeco', 'Double Cup Espresso', 10000, 5, 10, 7, 0, NULL, 0, '10000', '1', 1);
...
(4, 'BENGUET', 1500, 9000, -11100, '80', 1, 0, NULL, 0, 1),
(5, 'COLOMBIA', 2000, 10000, -27399, '90', 1, 0, NULL, 0, 1),
