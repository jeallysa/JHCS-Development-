...
<head>
    ...
    <title>Stickers Inventory Stocks</title>
                                             ...
                                             <tr>
                                                ...
                                                <div class="modal fade" id="deactivate<?php echo $row->sticker_id;?>" tabindex="-1" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="contactLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="panel panel-primary">
                                                            <div class="panel-heading" >
                                                                <button type="button" class="close" data-dismiss="modal" onclick="document.getElementById('button<?php echo $row->sticker_id;?>').click()" aria-hidden="true">×</button>
                                                                <h4 class="panel-title" id="contactLabel"><span class="glyphicon glyphicon-warning-sign"></span> Activation/Deactivation </h4>
                                                            </div>
                                                            <form action="<?php echo base_url(); ?>AdminStickers/activation" method="post" accept-charset="utf-8">
                                                                <div class="modal-body" style="padding: 5px;">
                                                 ...
                                                 <div class="modal fade" id="updatestickers<?php echo $row->sticker_id;?>" tabindex="-1" role="dialog" aria-labelledby="contactLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="panel panel-primary">
                                                        <div class="panel-heading" >
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                            <h4 class="panel-title" id="contactLabel"><span class="glyphicon glyphicon-info-sign"></span> Update Stickers</h4>
                                                        </div>
                                                        <form action="<?php echo base_url(); ?>AdminStickers/update" method="post" accept-charset="utf-8">
                                                            <div class="modal-body" style="padding: 5px;">
                                                                 ...
                                                                 <div class="row">
                                                                    <div class="col-md-12 form-group">
                                                                        <div class="form-group label-floating">
                                                                            <label for="email">Name</label>
                                                                            <input class="form-control" type="text" name="name" value="<?php echo $row->sticker; ?>" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                ...
                                                                <div class="row">
                                                                     <div class="col-lg-6 form-group">
                                                                        <div class="form-group label-floating">
                                                                            <label for="email">Reorder Level</label>
                                                                            <input class="form-control" value="<?php echo $row->sticker_reorder; ?>" type="number" name="reorder" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6 form-group">
                                                                        <div class="form-group label-floating">
                                                                            <label for="email">Stock Limit</label>
                                                                            <input class="form-control" value="<?php echo $row->sticker_limit; ?>" type="number" name="stocklimit" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6 form-group">
                                                                        <div class="form-group label-floating">
                                                                            <label for="email">Number of Stocks</label>
                                                                            <input class="form-control" value="<?php echo $row->sticker_stock; ?>" type="number" name="stocks" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6 form-group">
                                                                           <div class="form-group label-floating">
