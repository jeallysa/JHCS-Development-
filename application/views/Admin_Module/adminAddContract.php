                            ...
                            <div class="modal-body" style="padding: 5px;">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" name="date_started" type="date" class="no-border" value="<?php echo date("Y-m-d", strtotime($row->date_started));?>" data-validate="required" message="Date of Purchase is recquired! min="<?=date('Y-m-d')?>" max="<?=date('Y-m-d',strtotime(date('Y-m-d').'+1 days'))?>"">
                                        </div>
                                         <div class="form-group label-floating">
                                            <label for="email">Date Expiration</label>
                                            <input class="form-control" name="date_expiration" type="date" class="no-border" value="<?php echo date("Y-m-d", strtotime($row->date_expiration));?>" data-validate="required" message="Date of Purchase is recquired! min="<?=date('Y-m-d')?>" max="<?=date('Y-m-d',strtotime(date('Y-m-d').'+1 days'))?>"">
                                        </div>
                                        <?php
                                            }
                                        ?>
