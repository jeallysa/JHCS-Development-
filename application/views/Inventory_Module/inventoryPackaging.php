                            ...
                            <div class="modal-body" style="padding: 5px;">
                                <div id="page-wrapper">
                                    ...
                                    <label>Filter By:</label>
                                        ...
                                        <?php
                     $retrieveDetails3 ="SELECT * FROM company_returns INNER JOIN supp_po_ordered ON company_returns.poNo = supp_po_ordered.supp_po_id INNER JOIN supp_po ON supp_po_ordered.supp_po_id = supp_po.supp_po_id INNER JOIN supplier ON supp_po.supp_id = supplier.sup_id INNER JOIN packaging ON supp_po_ordered.item = packaging.package_type WHERE package_id = ".$id ; 
