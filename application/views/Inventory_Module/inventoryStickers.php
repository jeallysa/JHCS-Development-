                            ...
                            <div class="modal-body" style="padding: 5px;">
                                ...
                                <div id="page-wrapper">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <form action="InventorySticker/update/<?php echo $id ?>" method="post" accept-charset="utf-8">
                                                            <div class="row">
                                      ...
                                      $mapModal = 1;
                                          foreach($sticker as $object){ 
                                           ...
                                           echo '<tr>' ,
                                                ...
                                                '<td>'  . number_format($object->sticker_limit)  . ' pc/s</td>' ,
...
<?php
    ...
    foreach($sticker as $object){
       $temp =  $object->sticker_id;
         ...
         $i = 1; //after every PO it returns to 1
                        ...
                        $retrieveDetails ="SELECT * FROM jhcs.sticker NATURAL JOIN supplier WHERE sticker_activation = '1';";
  ...
  $(document).ready(function(){                
           $(<?php echo "'#details".$c." input[id=physcount".$i."]'"?>).keyup(function(){
            ...
            var x = parseFloat($(<?php echo "'#details".$c." input[id=stckrstocks".$i."]'"?>).val());
            var res = x - y ;
