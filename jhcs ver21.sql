...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2018 at 07:54 AM
...
(27, 16, 'dr555', 'si555', '2018-03-25', 118750, 'Mel Rommel', 2, 'unpaid', 'Received');
...
(13, '2018-03-14', 1, '', 1, 's555', 'for repair', '', 'No');
...
INSERT INTO `contract` (`contract_id`, `date_started`, `blend_id`, `package_id`, `client_id`, `required_qty`, `credit_term`) VALUES
(3, '2017-10-15', 2, 3, 1, 75, '30 days'),
(4, '2017-04-11', 4, 6, 2, 125, '15 days'),
(5, '2016-09-22', 10, 2, 3, 100, '30 days'),
(6, '2015-03-15', 15, 4, 4, 150, '15 days');
...
(16, 2, 4, NULL, '2018-03-26', 125, 'delivered'),
(17, 1, 2, NULL, '2018-03-26', 75, 'pending'),
(18, 4, 15, NULL, '2018-03-26', 150, 'pending'),
(19, 3, 10, NULL, '2018-03-26', 20, 'pending'),
(20, 3, 10, NULL, '2018-03-26', 100, 'pending'),
(21, 2, 4, NULL, '2018-03-26', 125, 'pending'),
...
INSERT INTO `inv_transact` (`trans_id`, `transact_date`, `dr_client`, `dr_supplier`, `type`) VALUES
(1, '2017-01-10', NULL, 11, 'IN'),
(2, '2017-02-02', NULL, 12, 'IN'),
(3, '2017-06-07', NULL, 13, 'IN'),
(4, '2017-12-12', NULL, 14, 'IN'),
(5, '2018-01-18', 'dr111', NULL, 'OUT'),
(6, '2018-01-31', 'dr222', NULL, 'OUT'),
(7, '2018-02-06', 'dr333', NULL, 'OUT'),
(8, '2018-10-10', 'dr444', NULL, 'OUT'),
(9, '2018-03-22', 'dr555', NULL, 'OUT');
...
(4, 'brown', '1000', 50, 200, 69, 0, NULL, 0, '32', 2, 1, 'brown bag 1000'),
...
(1, 'GUATEMALA', 5000, 10000, 74000, '80', 1, 0, NULL, 0, 1),
(2, 'SUMATRA', 3200, 7001, 7400, '70', 2, 0, NULL, 0, 1),
(3, 'ROBUSTA', 1000, 8500, 500, '60', 2, 0, NULL, 0, 1),
(4, 'BENGUET', 1500, 9000, 500, '80', 1, 0, NULL, 0, 1),
(5, 'COLOMBIA', 2000, 10000, 1000, '90', 1, 0, NULL, 0, 1),
(6, 'BARAKO', 2500, 10500, 6200, '76', 1, 0, NULL, 0, 1);
...
--
ALTER TABLE `client_delivery`
  MODIFY `client_deliveryID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
-- AUTO_INCREMENT for table `client_machreturn`
--
ALTER TABLE `client_machreturn`
  MODIFY `client_machReturnID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
...
--
ALTER TABLE `contracted_po`
  MODIFY `contractPO_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
...
--
ALTER TABLE `machine_out`
  MODIFY `mach_salesID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `trans_mach`
  MODIFY `tmach_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `trans_stick`
  MODIFY `tstick_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `walkin_sales`
  MODIFY `walkin_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
--
