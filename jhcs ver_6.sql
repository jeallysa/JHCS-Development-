...
INSERT INTO `contracted_po` VALUES (1,1,1,1,'2018-02-14',300,'delivered'),(2,2,2,2,'2018-02-08',300,'pending');
...
CREATE TABLE `trans_stick` (
  ...
  CONSTRAINT `stick_trans` FOREIGN KEY (`sticker_id`) REFERENCES `sticker` (`sticker_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `stick_trans2` FOREIGN KEY (`trans_id`) REFERENCES `inv_transact` (`trans_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `trans_stick` VALUES (1,1,1,100),(2,2,2,50),(3,1,3,30),(4,1,4,110),(5,2,5,20),(6,1,6,150),(7,2,7,100),(8,2,8,200);
...
-- Dump completed on 2018-03-18 12:07:15
