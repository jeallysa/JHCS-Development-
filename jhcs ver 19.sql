...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 26, 2018 at 10:58 PM
...
(3, '2018-03-01', 2, '1                   ', 1, 's111', 'destroyed', ''),
(4, '2018-03-26', 1, '4                   ', 1, 's333', 'for repair', '');
...
(3, 1, 's333', '2018-03-26', 1, 4, 'Returned', 'sold');
...
--
ALTER TABLE `client_machreturn`
  MODIFY `client_machReturnID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
