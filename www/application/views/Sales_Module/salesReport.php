...
<script>   
    ...
    var oTable = $('#example').dataTable({ 
        ...
        "info":     false,
        buttons: [
            { "extend": 'print', "text":'<i class="fa fa-files-o"></i> Print',"className": 'btn btn-default btn-xs',"orientation": "landscape", "title":'John Hay Coffee Services, Inc. ',
             "messageTop": 'Sales Report',

            },
            
            { "extend": 'excel', 
             "title":'John Hay Coffee Services, Inc. ',
             "messageTop": 'Sales Report',
