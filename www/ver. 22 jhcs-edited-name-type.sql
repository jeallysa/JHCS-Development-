...
INSERT INTO `client_coffreturn` VALUES (9,'dr1q1','2018-03-14',100,'kulang','Sample','Yes',18),(10,'dr222','2018-03-29',200,'Damaged','Sample','Yes',16),(11,'dr362','2018-03-23',120,'Spoiled','','No',19),(12,'dr111','2018-03-25',50,'spoiled','','No',23),(13,'dr222','2018-03-24',50,'wrong product','','No',24);
...
INSERT INTO `client_delivery` VALUES (23,12,'dr111','si111','2018-03-25',51250,'Jenella Salvador',2,'unpaid','Returned'),(24,13,'dr222','si222','2018-03-24',51250,'Alvin Noel',1,'unpaid','Returned'),(25,14,'dr333','si333','2018-03-19',20500,'Joel Cruz',2,'paid','Received'),(26,15,'dr444','si444','2018-03-05',80000,'Dian Deli',3,'paid','Received'),(27,16,'dr555','si555','2018-03-25',118750,'Mel Rommel',2,'unpaid','Received');
...
INSERT INTO `client_machreturn` VALUES (13,'2018-03-14',1,'',1,'s555','for repair','','No');
...
INSERT INTO `coffee_blend` VALUES (1,'Guatemala Rainforest','4',1025,10,0,NULL,0,1,'Existing'),(2,'Guatemala Rainforest','5',615,7,0,NULL,0,1,'Existing'),(3,'Guatemala Rainforest','6',365,4,0,NULL,0,1,'Existing'),(4,'Cordillera Sunrise','4',950,8,0,NULL,0,1,'Existing'),(5,'Cordillera Sunrise','5',575,6,0,NULL,0,1,'Existing'),(6,'Cordillera Sunrise','6',350,5,0,NULL,0,1,'Existing'),(7,'Sumatra Night','4',850,7,0,NULL,0,1,'Existing'),(8,'Sumatra Night','5',530,10,0,NULL,0,1,'Existing'),(9,'Sumatra Night','6',325,11,0,NULL,0,1,'Existing'),(10,'Chef\'s Blend','4',800,5,0,NULL,0,1,'Existing'),(11,'Chef\'s Blend','5',465,9,0,NULL,0,1,'Existing'),(12,'Chef\'s Blend','6',265,16,0,NULL,0,1,'Existing'),(13,'Espresso Blend','4',750,2,0,NULL,0,1,'Existing'),(14,'Espresso Blend','5',415,3,0,NULL,0,1,'Existing'),(15,'Espresso Blend','6',230,5,0,NULL,0,1,'Existing'),(16,'Breakfast Blend','1',675,7,0,NULL,0,1,'Existing'),(17,'Breakfast Blend','2',375,9,0,NULL,0,1,'Existing'),(18,'Breakfast Blend','3',200,5,0,NULL,0,1,'Existing'),(19,'Mabuhay Blend','1',600,4,0,NULL,0,1,'Existing'),(20,'Mabuhay Blend','2',350,6,0,NULL,0,1,'Existing'),(21,'Mabuhay Blend','3',180,3,0,NULL,0,1,'Existing'),(22,'Fiesta Blend','1',500,8,0,NULL,0,1,'Existing'),(23,'Fiesta Blend','2',315,9,0,NULL,0,1,'Existing'),(24,'Fiesta Blend','3',165,7,0,NULL,0,1,'Existing'),(25,'Kalayaan Blend','1',400,5,0,NULL,0,1,'Existing'),(26,'Kalayaan Blend','2',275,1,0,NULL,0,1,'Existing'),(27,'Kalayaan Blend','3',150,2,0,NULL,0,1,'Existing'),(28,'Pizza Volante Blend','2',500,20,0,NULL,0,1,'Client'),(29,'The Manor Blend','3',300,12,0,NULL,0,1,'Client');
...
INSERT INTO `contract` VALUES (3,'2017-10-15',2,3,1,75,'30 days'),(4,'2017-04-11',4,6,2,125,'15 days'),(5,'2016-09-22',10,2,3,100,'30 days'),(6,'2015-03-15',15,4,4,150,'15 days');
...
INSERT INTO `contracted_po` VALUES (12,2,1,NULL,'2018-03-26',50,'delivered'),(13,1,1,NULL,'2018-03-26',50,'delivered'),(14,2,1,NULL,'2018-03-26',20,'delivered'),(15,3,10,NULL,'2018-03-26',100,'delivered'),(16,2,4,NULL,'2018-03-26',125,'delivered'),(17,1,2,NULL,'2018-03-26',75,'pending'),(18,4,15,NULL,'2018-03-26',150,'pending'),(19,3,10,NULL,'2018-03-26',20,'pending'),(20,3,10,NULL,'2018-03-26',100,'pending'),(21,2,4,NULL,'2018-03-26',125,'pending'),(22,1,2,NULL,'2018-03-26',75,'pending');
...
INSERT INTO `inv_transact` VALUES (1,'2017-01-10',NULL,11,'IN'),(2,'2017-02-02',NULL,12,'IN'),(3,'2017-06-07',NULL,13,'IN'),(4,'2017-12-12',NULL,14,'IN'),(5,'2018-01-18','dr111',NULL,'OUT'),(6,'2018-01-31','dr222',NULL,'OUT'),(7,'2018-02-06','dr333',NULL,'OUT'),(8,'2018-10-10','dr444',NULL,'OUT'),(9,'2018-03-22','dr555',NULL,'OUT');
...
INSERT INTO `machine` VALUES (1,'Saeco','Double Cup Espresso',10000,5,10,100,0,NULL,0,10000,'1',1,4),(2,'Saeco','Double Cup Espresso',200,5,20,10,0,NULL,0,NULL,'2',1,4);
...
INSERT INTO `machine_out` VALUES (1,1,'s111','2018-03-07',2,1,'Received','sold'),(2,1,'s222','2018-03-26',1,1,'Received','sold'),(3,1,'s333','2018-03-26',1,4,'Received','sold'),(4,1,'s444','2017-10-15',1,1,'Received','rented'),(5,1,'s555','2017-04-11',1,2,'Returned','rented'),(6,1,'ss1','2018-03-07',1,3,'Received','sold');
...
INSERT INTO `packaging` VALUES (1,'clear bag','1000',50,200,60,0,NULL,0,12,1,1,'clear bag 1000',2),(2,'clear bag','500',50,200,137,0,NULL,0,23,2,1,'clear bag 500',2),(3,'clear bag','250',50,200,90,0,NULL,0,12,1,1,'clear bag 250',2),(4,'brown bag','1000',50,200,69,0,NULL,0,32,2,1,'brown bag 1000',2),(5,'brown bag','500',50,200,92,0,NULL,0,12,1,1,'brown bag 500',2),(6,'brown bag','250',50,200,137,0,NULL,0,12,2,1,'brown bag 250',2);
...
INSERT INTO `payment_contracted` VALUES (6,'dr333','cr333','Bank deposit','2018-03-08',20000,500,'tax withheld'),(7,'dr444','cr444','Cash on Delivery','2018-03-15',79500,500,'tax withheld');
...
INSERT INTO `raw_coffee` VALUES (1,'GUATEMALA','City Roast',5000,10000,0,80,1,0,NULL,0,1,1),(2,'SUMATRA','City Roast',3200,7001,45,70,2,0,NULL,0,1,1),(3,'ROBUSTA','City Roast',1000,8500,0,60,2,0,NULL,0,1,1),(4,'BENGUET','City Roast',1500,9000,0,80,1,0,NULL,0,1,1),(5,'COLOMBIA','City Roast',2000,10000,0,90,1,0,NULL,0,1,1),(6,'BARAKO','City Roast',2500,10500,0,76,1,0,NULL,0,1,1);
...
INSERT INTO `sticker` VALUES (1,'Marios','type',500,1000,600,0,NULL,0,5,1,1,3),(2,'Manor','type',500,1000,700,0,NULL,0,6,2,0,3);
...
INSERT INTO `supp_delivery` VALUES (30,42,30,'2018-03-29',45,0,'Tin Caguioa');
...
INSERT INTO `supp_po` VALUES (30,2,'2018-03-29',1,'1',45,3151,'1','0',NULL),(31,1,'2018-03-29',1,'1',101,3881,'0','0',NULL),(32,1,'2018-03-22',1,'1',45,35,'0','0',NULL);
...
INSERT INTO `supp_po_ordered` VALUES (42,30,'SUMATRA',45,3150,'City Roast','1','0',NULL),(43,31,'Marios',56,280,'type','0','0',NULL),(44,31,'BENGUET',45,3600,'City Roast','0','0',NULL),(45,32,'BARAKO',45,34,'City Roast','0','0',NULL);
...
INSERT INTO `trans_mach` VALUES (1,1,1,'2'),(2,1,2,'5'),(3,1,3,'3'),(4,1,4,'4'),(5,1,5,'2'),(6,1,6,'5'),(7,1,7,'3'),(8,1,8,'1'),(9,NULL,9,NULL);
...
INSERT INTO `trans_pack` VALUES (1,1,2,200),(2,1,3,300),(3,1,4,600),(4,1,6,100),(5,2,1,450),(6,2,3,800),(7,3,2,650),(8,4,2,700),(9,5,3,200),(10,5,4,350),(11,6,1,400),(12,6,5,500),(13,6,6,500),(14,7,1,100),(15,8,1,100),(16,9,5,3),(17,10,4,1),(18,11,4,21),(19,12,4,11);
...
INSERT INTO `trans_stick` VALUES (1,1,1,100),(2,2,2,50),(3,1,3,30),(4,1,4,110),(5,2,5,20),(6,1,6,150),(7,2,7,100),(8,2,8,200),(9,NULL,9,NULL),(10,NULL,10,NULL),(11,NULL,11,NULL),(12,NULL,12,NULL);
...
INSERT INTO `walkin_sales` VALUES (1,'2018-02-15',2,2,1),(2,'2018-02-15',3,3,2),(46,'2018-03-21',12,1,NULL),(47,'2018-03-21',2,10,NULL),(50,'2018-03-22',2,3,NULL),(51,'2018-03-22',2,3,NULL),(52,'2018-03-22',2,3,NULL),(53,'2018-03-22',3,2,NULL),(54,'2018-03-26',1,10,NULL),(55,'2018-03-26',21,1,NULL),(56,'2018-03-26',11,1,NULL);
/*!40000 ALTER TABLE `walkin_sales` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'jhcsn'
--
...
-- Dump completed on 2018-03-29 12:49:24
