...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 31, 2018 at 08:36 AM
...
(41, 'dr111', 123, '2018-03-31', 0, 'spoiled', '', 'Yes'),
(42, '', 63, '2018-03-31', 5, 'wrong blend', '', 'No'),
(43, '', 63, '2018-03-31', 5, 'wrong blend', '', 'No'),
(44, '', 61, '2018-03-15', 1, 'wrong blend', '', 'No'),
(45, '', 62, '2018-03-31', 2, 'wrong blend', '', 'No');
...
(123, 'dr111', 55, 'si111', '2018-03-30', 80000, 'Ikang Bagtilay', 100, 3, 0, 'unpaid', 'Received');
...
(1, 'Guatemala Rainforest', '4', 1025, 48, 0, NULL, 0, 1, 'Existing', 1),
(2, 'Guatemala Rainforest', '5', 615, 7, 0, NULL, 0, 1, 'Existing', 1),
(3, 'Guatemala Rainforest', '6', 365, 4, 0, NULL, 0, 1, 'Existing', 1),
(4, 'Cordillera Sunrise', '4', 950, 61, 0, NULL, 0, 1, 'Existing', 1),
...
(10, 'Chef\'s Blend', '4', 800, 357, 0, NULL, 0, 1, 'Existing', 1),
...
INSERT INTO `contract` (`contract_id`, `date_started`, `blend_id`, `package_id`, `client_id`, `required_qty`, `credit_term`, `mach_id`, `mach_salesID`, `date_expiration`) VALUES
(3, '2017-10-15', 2, 3, 1, 75, '30 days', 1, 1, NULL),
(4, '2017-04-11', 4, 6, 2, 125, '15 days', 1, 1, NULL),
(5, '2016-09-22', 10, 2, 3, 100, '30 days', 1, 1, NULL),
(6, '2015-03-15', 15, 4, 4, 150, '15 days', 1, 1, NULL);
...
(55, 3, 10, NULL, '2018-03-31', 100, 100, 'delivered'),
(56, 2, 4, NULL, '2018-03-31', 125, 125, 'delivered'),
(57, 1, 2, NULL, '2018-03-31', 75, 0, 'pending'),
(58, 4, 15, NULL, '2018-03-31', 150, 0, 'pending');
...
(16, '2018-03-31', NULL, NULL, NULL, 'OUT'),
(17, '2018-03-31', NULL, NULL, NULL, 'OUT'),
(18, '2018-03-31', NULL, NULL, NULL, 'OUT');
...
(1, 'Saeco', 'Double Cup Espresso', 10000, 5, 10, 142, 0, NULL, 0, '10000', '1', 1),
(2, 'Jeanne', 'Jeanne Machine', 200, 5, 20, 15, 0, NULL, 0, NULL, '1', 1);
...
(1, 1, 's111', '2018-03-07', 2, 1, 'Returned', 'sold'),
...
(4, 'brown', '1000', 50, 200, -8, 0, NULL, 0, '32', 2, 1, 'brown bag 1000'),
...
(1, 'GUATEMALA', 5000, 10000, 72900, '80', 1, 0, NULL, 0, 1, 'city'),
(2, 'SUMATRA', 3200, 7001, -33800, '70', 2, 0, NULL, 0, 1, 'medium'),
(3, 'ROBUSTA', 1000, 8500, -26700, '60', 2, 0, NULL, 0, 1, 'light'),
(4, 'BENGUET', 1500, 9000, -1600, '80', 1, 0, NULL, 0, 1, 'light'),
(5, 'COLOMBIA', 2000, 10000, -3200, '90', 1, 0, NULL, 0, 1, 'city'),
(6, 'BARAKO', 2500, 10500, 5000, '76', 1, 0, NULL, 0, 1, 'city');
...
(1, 'Marios', 500, 1000, 527, 0, NULL, 0, '5', 1, 1),
...
--
ALTER TABLE `client_coffreturn`
  MODIFY `client_coffReturnID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
--
...
--
ALTER TABLE `client_machreturn`
  MODIFY `client_machReturnID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
...
--
ALTER TABLE `supp_delivery`
  MODIFY `supp_delivery_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
...
--
ALTER TABLE `supp_po`
  MODIFY `supp_po_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
-- AUTO_INCREMENT for table `supp_po_ordered`
--
ALTER TABLE `supp_po_ordered`
  MODIFY `supp_po_ordered_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
--
-- AUTO_INCREMENT for table `supp_temp_po_order`
--
ALTER TABLE `supp_temp_po_order`
  MODIFY `idsupp_temp_po_order` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `trans_mach`
  MODIFY `tmach_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT for table `trans_pack`
--
ALTER TABLE `trans_pack`
  MODIFY `tp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
...
--
ALTER TABLE `trans_stick`
  MODIFY `tstick_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
...
--
ALTER TABLE `walkin_sales`
  MODIFY `walkin_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
--
