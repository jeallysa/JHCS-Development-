...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2018 at 10:15 AM
...
INSERT INTO `coffee_blend` (`blend_id`, `blend`, `bag`, `size`, `blend_price`, `blend_activation`, `blend_type`) VALUES
(1, 'Guatemala Rainforest', 'brown', 1000, 1025, 1, 'Existing'),
(2, 'Guatemala Rainforest', 'brown', 500, 615, 1, 'Existing'),
(3, 'Guatemala Rainforest', 'brown', 250, 365, 1, 'Existing'),
(4, 'Cordillera Sunrise', 'brown', 1000, 950, 1, 'Existing'),
(5, 'Cordillera Sunrise', 'brown', 500, 575, 1, 'Existing'),
(6, 'Cordillera Sunrise', 'brown', 250, 350, 1, 'Existing'),
(7, 'Sumatra Night', 'brown', 1000, 850, 1, 'Existing'),
(8, 'Sumatra Night', 'brown ', 500, 530, 1, 'Existing'),
(9, 'Sumatra Night', 'brown', 250, 325, 1, 'Existing'),
(10, 'Chef\'s Blend', 'brown', 1000, 800, 1, 'Existing'),
(11, 'Chef\'s Blend', 'brown', 500, 465, 1, 'Existing'),
(12, 'Chef\'s Blend', 'brown', 250, 265, 1, 'Existing'),
(13, 'Espresso Blend', 'brown', 1000, 750, 1, 'Existing'),
(14, 'Espresso Blend', 'brown', 500, 415, 1, 'Existing'),
(15, 'Espresso Blend', 'brown', 250, 230, 1, 'Existing'),
(16, 'Breakfast Blend', 'brown', 1000, 675, 1, 'Existing'),
(17, 'Breakfast Blend', 'brown', 500, 375, 1, 'Existing'),
(18, 'Breakfast Blend', 'brown', 250, 200, 1, 'Existing'),
(19, 'Mabuhay Blend', 'brown', 1000, 600, 1, 'Existing'),
(20, 'Mabuhay Blend', 'brown', 500, 350, 1, 'Existing'),
(21, 'Mabuhay Blend', 'brown', 250, 180, 1, 'Existing'),
(22, 'Fiesta Blend', 'brown', 1000, 500, 1, 'Existing'),
(23, 'Fiesta Blend', 'brown', 500, 315, 1, 'Existing'),
(24, 'Fiesta Blend', 'brown', 250, 165, 1, 'Existing'),
(25, 'Kalayaan Blend', 'brown', 1000, 400, 1, 'Existing'),
(26, 'Kalayaan Blend', 'brown', 500, 275, 1, 'Existing'),
(27, 'Kalayaan Blend', 'brown', 250, 150, 1, 'Existing');
...
CREATE TABLE `test_category` (
  `idtest_category` int(11) NOT NULL,
...
CREATE TABLE `test_supp_delivery` (
  `idtest_supp_delivery` int(11) NOT NULL,
...
ALTER TABLE `test_category`
  ADD PRIMARY KEY (`idtest_category`);
...
--
-- Indexes for table `test_multi_insert`
--
ALTER TABLE `test_multi_insert`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `test_supp_delivery`
--
ALTER TABLE `test_supp_delivery`
  ADD PRIMARY KEY (`idtest_supp_delivery`);

--
-- Indexes for table `test_supp_po`
--
ALTER TABLE `test_supp_po`
  ADD PRIMARY KEY (`supp_po_id`);

--
-- Indexes for table `test_supp_po_ordered`
--
ALTER TABLE `test_supp_po_ordered`
  ADD PRIMARY KEY (`test_supp_po_ordered_id`);

--
-- Indexes for table `test_supp_temp_po`
--
ALTER TABLE `test_supp_temp_po`
  ADD PRIMARY KEY (`id_supp_temp_PO`);

--
-- Indexes for table `test_transac_history`
--
ALTER TABLE `test_transac_history`
...
--
ALTER TABLE `test_category`
  MODIFY `idtest_category` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `test_multi_insert`
--
ALTER TABLE `test_multi_insert`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
-- AUTO_INCREMENT for table `test_supp_delivery`
--
ALTER TABLE `test_supp_delivery`
  MODIFY `idtest_supp_delivery` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `test_supp_po`
--
ALTER TABLE `test_supp_po`
  MODIFY `supp_po_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `test_supp_po_ordered`
--
ALTER TABLE `test_supp_po_ordered`
  MODIFY `test_supp_po_ordered_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `test_supp_temp_po`
--
ALTER TABLE `test_supp_temp_po`
  MODIFY `id_supp_temp_PO` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `test_transac_history`
--
ALTER TABLE `test_transac_history`
