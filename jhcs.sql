...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 19, 2018 at 04:23 AM
...
INSERT INTO `client_delivery` (`client_deliveryID`, `contractPO_no`, `client_dr`, `client_invoice`, `client_deliverDate`, `client_amount`, `client_receive`, `payment_remarks`, `client_id`) VALUES
(1, 3, 'dr234', '234', '2018-02-13', 10000, 'Mark De Vera', 'unpaid', 1),
(2, 1, 'dr233', '233', '2018-02-12', 13000, 'Leah Ramos', 'paid', 2);
...
INSERT INTO `contracted_po` (`contractPO_id`, `client_id`, `blend_id`, `contractPO_no`, `contractPO_date`, `contractPO_qty`, `delivery_stat`) VALUES
(0, 1, 1, 'PO111', '2018-02-06', 300, 'pending'),
(0, 2, 2, 'PO222', '2018-02-05', 300, 'pending');
...
INSERT INTO `payment_contracted` (`paid_id`, `collection_no`, `client_dr`, `payment_mode`, `paid_date`, `paid_amount`, `gross_amount`, `withheld`, `payment_remarks`) VALUES
(1, 'C111', 'dr233', 'bank', '2018-02-15', 10000, 10000, 0, 'full');
