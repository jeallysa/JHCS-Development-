...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 22, 2018 at 08:05 AM
...
CREATE TABLE `sample` (
  ...
  `client_coffreturn_id` int(11) NOT NULL,
  `package_id` int(11) NOT NULL,
...
INSERT INTO `sample` (`sample_id`, `sample_date`, `sample_recipient`, `sample_type`, `client_coffreturn_id`, `package_id`, `sticker_id`) VALUES
(1, NULL, 'Walkin Client', 'freebies', 1, 4, 1),
(2, NULL, 'The Manor', 'free taste', 2, 5, 1);
